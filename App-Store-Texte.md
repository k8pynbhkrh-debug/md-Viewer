...
Reihenfolge (identisch für iPhone und iPad) — das „Öffnen mit" steht bewusst an Position 1, weil es den Einstieg in die App zeigt:
...
- `03-uebersicht.png` — Dokument mit Überschriften, Aufgabenliste, Tabelle (Status-Emoji), Zitat, Links
